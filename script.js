document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getErrorMessage(field, type) {
      const label = field.closest('label, .form-group, .field-wrapper')
        ?.querySelector('label')
        ?.textContent?.trim() || field.getAttribute('placeholder') || field.name || 'This field';
    ...
    function validateField(field) {
      ...
      if (field.hasAttribute('minlength') && field.value.trim() !== '') {
        ...
        if (!VALIDATORS.minlength(field.value, min)) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מאור נדלן 46 משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'f6b87a73-26d8-45b1-9cd9-c34432b40f65',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'f6b87a73-26d8-45b1-9cd9-c34432b40f65';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'f6b87a73-26d8-45b1-9cd9-c34432b40f65';
